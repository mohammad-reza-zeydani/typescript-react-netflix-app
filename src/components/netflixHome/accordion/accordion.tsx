    ...
    <div className='flex w-full justify-center items-center'>
      ...
      {/* Accordion open & close button and the title */}
        <button
          ...
          className='flex justify-between items-center z-50 w-full active:bg-blue-500 focus:bg-neutral-800 bg-neutral-800/40  px-2 py-3 xs:p-3 sm:p-5 cursor-pointer'>
